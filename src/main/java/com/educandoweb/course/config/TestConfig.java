...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception { // tudo que colocar dentro desse método, vai ser executado quando a aplicação for inicializada.
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"),OrderStatus.PAID, u1); // padrão Iso8601
		...
		// para salvar um objeto dependente numa relação um pra um, não chama o repository do próprio objeto.
